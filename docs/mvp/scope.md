...
- 2026-05-04 又补出 Canvas unit layout nudge 的正式边界：`CanvasUnitLayoutMoveRequested` 只更新 `<project>.rfstudio-layout.json` 中的单元坐标，保存后重开可恢复，且不会把布局移动误记为项目文档修改
