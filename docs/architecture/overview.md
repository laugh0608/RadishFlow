...
- `StudioGuiWindowLayoutState` 作为正式布局状态契约，覆盖 `panel dock_region/visibility/collapsed/order`、region 内 stack placement、`center_area`、`region_weights` 与多窗口 `layout scope`
