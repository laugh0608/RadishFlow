...
2026-09-16 后续确认补入 [工程设计基础、工况与来源](../topics/engineering-basis-and-cases.md)、目标反算、分层工程检查、压力 / 公用工程、候选权衡与轻量工程交付。先细化共同条件、工况矩阵和来源及其 UI 关系，工程数值和专业检查随模型能力推进；B3-5 无界面建模已接通，后续按 U1 单位基础及规格 / 设备依赖推进。
