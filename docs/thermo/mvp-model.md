...
1. 先把当前 three-composition two-phase 与 synthetic 单相样例都已前推到 integration / workspace run path 的 near-boundary `±ΔP / ±ΔT` 基线维持为正式回归；若继续扩展，优先沿同一模式补到更多非 flash 中间流股 / flash inlet 链路
