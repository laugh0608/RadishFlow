...
- 明日事项（2026-09-15）：优先 [Cooler 空白建模与温压结果闭环](unitops/heater-cooler.md#b2-5候选cooler-空白建模与温压结果闭环)，具体优先级见 [当前状态](../status/current.md#明日事项2026-09-15)。远距离视口及 Windows / Linux 原生路径继续待验证。
