...
本轮收口：受控 Feed–Flash 创建、参数提交、连接、目标端断开 / 重连、流股删除、命令面板撤销 / 重做和结果旧化已有实窗证据；单元删除 / 重命名缺失，macOS 首次保存缺失。完整 [编辑台账与 B1-1 候选](flowsheet-modeling-and-solve.md#b0-编辑能力复核2026-09-13)、[保存 / 重开分层结论](project-lifecycle-storage.md#b0-保存与重开复核2026-09-13) 与 [操作流水](../devlogs/2026-09/2026-W37.md#2026-09-13-b0-基础能力复核) 分别维护。其他单元逐项实窗、快捷键、导出和 Windows / Linux 本轮运行态仍待验证；B0 收口表示已建立差距与候选验收，不表示全部基础能力已通过。
...
- 当前状态：Active
- 最近更新：2026-09-13，完成首轮 B0 代码、定向测试与 macOS 普通空白项目实窗复核。
- 下一步：确认建模专题 B1-1 单元删除及关联清理的范围与验收；macOS 文件选择器单独收口，本轮未实施 B1。
