...
- 打开已有 `*.rfproj.json` 项目
- 通过首页 `打开示例`、`打开项目`、`继续上次项目` 或进入工作台后的顶部主路径切换项目
...
- `开始`：`继续上次项目`、`新建空白项目`、`打开项目`、`打开示例`
- `最近项目`：显示最近项目、路径摘要、物性包和就绪 / 缺失状态
- `示例项目`：显示内置示例、流程摘要、组分、物性包和打开入口
- `环境`：显示客户端、服务端和设备三组摘要
...
1. 在首页点击 `新建空白项目`，或进入工作台后点击顶部 `新建空白`。
