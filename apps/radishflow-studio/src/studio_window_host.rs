...
impl StudioRuntimeHostPort {
    ...
    pub fn begin_canvas_place_unit(
        ...
        self.runtime.begin_canvas_place_unit(unit_kind)
    }

    pub fn cancel_canvas_pending_edit(&mut self) -> Option<rf_ui::CanvasEditIntent> {
        self.runtime.cancel_canvas_pending_edit()
    }
    ...
    pub fn commit_canvas_pending_edit_at(
        ...
        self.runtime.commit_canvas_pending_edit_at(position)
    }
    ...
    pub fn disconnect_selected_stream_source_connection(
        ...
        self.runtime.disconnect_selected_stream_source_connection()
    }

    pub fn disconnect_selected_stream_sink_connection(
        &mut self,
    ) -> RfResult<Option<rf_ui::StreamConnectionEditResult>> {
        self.runtime.disconnect_selected_stream_sink_connection()
    }
