...
internal static class CapeOpenRegistryPlanBuilder
{
        ...
        string unresolvedComHostPath)
    {
        ...
        [
            ...
            SetDefaultValue(hive, clsidKey, RadishFlow.CapeOpen.UnitOp.Mvp.UnitOperation.UnitOperationComIdentity.DisplayName, "Expose the COM class display name."),
            SetValue(hive, clsidKey, "ProgID", RadishFlow.CapeOpen.UnitOp.Mvp.UnitOperation.UnitOperationComIdentity.ProgId, "Bind CLSID to the stable ProgID."),
            SetValue(hive, clsidKey, "VersionIndependentProgID", RadishFlow.CapeOpen.UnitOp.Mvp.UnitOperation.UnitOperationComIdentity.ProgId, "Bind CLSID to the version-independent ProgID."),
            SetValue(hive, clsidKey, "VersionedProgID", RadishFlow.CapeOpen.UnitOp.Mvp.UnitOperation.UnitOperationComIdentity.VersionedProgId, "Bind CLSID to the current versioned ProgID."),
            ...
            SetDefaultValue(hive, progIdKey, RadishFlow.CapeOpen.UnitOp.Mvp.UnitOperation.UnitOperationComIdentity.DisplayName, "Expose the stable ProgID display name."),
            SetValue(hive, progIdKey, "CLSID", RadishFlow.CapeOpen.UnitOp.Mvp.UnitOperation.UnitOperationComIdentity.ClassId, "Bind stable ProgID to CLSID."),
            SetDefaultValue(hive, versionedProgIdKey, RadishFlow.CapeOpen.UnitOp.Mvp.UnitOperation.UnitOperationComIdentity.DisplayName, "Expose the versioned ProgID display name."),
            SetValue(hive, versionedProgIdKey, "CLSID", RadishFlow.CapeOpen.UnitOp.Mvp.UnitOperation.UnitOperationComIdentity.ClassId, "Bind versioned ProgID to CLSID."),
