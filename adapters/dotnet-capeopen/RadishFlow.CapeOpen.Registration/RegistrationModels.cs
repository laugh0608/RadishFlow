        ...
        string? typeLibraryPath)
    {
        ...
        return new CapeOpenRegistrationDescriptor(
            ...
            [
                ...
                new CapeOpenRegistrationCategory(
                    Name: "CAPE-OPEN Supports Thermodynamics 1.0",
                    CategoryId: RadishFlow.CapeOpen.Interop.Guids.CapeOpenCategoryIds.SupportsThermodynamics10),
                new CapeOpenRegistrationCategory(
            ...
            [
                ...
                new CapeOpenImplementedInterface(
                    Name: "IOleObject",
                    InterfaceId: RadishFlow.CapeOpen.Interop.Ole.ComOleInterfaceIds.IOleObject),
            ],
