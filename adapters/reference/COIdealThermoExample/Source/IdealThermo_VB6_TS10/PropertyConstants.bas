...
'two phase properties
  ...
  Public Const TwoPhasePropertyCount As Long = 6
...
Public TDepPropMoleBasis(0 To TDepPropertyCount - 1) As Boolean
...
If Not initialized Then
 ...
 TDepPropMoleBasis(0) = True '"heatOfVaporization",
 TDepPropMoleBasis(1) = True '"heatOfVaporization.Dtemperature",
 TDepPropMoleBasis(2) = True '"idealGasHeatCapacity",
 TDepPropMoleBasis(3) = True '"idealGasHeatCapacity.Dtemperature",
 TDepPropMoleBasis(4) = False '"vaporPressure",
 TDepPropMoleBasis(5) = False '"vaporPressure.Dtemperature"
 ...
 TwoPhasePropNames(0) = "kvalues"
 TwoPhasePropNames(1) = "kvalues.Dtemperature"
 TwoPhasePropNames(2) = "kvalues.Dpressure"
 TwoPhasePropNames(3) = "logkvalues"
 TwoPhasePropNames(4) = "logkvalues.Dtemperature"
 TwoPhasePropNames(5) = "logkvalues.Dpressure"
 initialized = True
End If
End Sub
