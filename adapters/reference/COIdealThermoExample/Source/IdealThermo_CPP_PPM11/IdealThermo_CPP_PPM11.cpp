// IdealThermo_CPP_PPM11.cpp : Implementation of DLL Exports.
...
/*! \mainpage CPP version 1.1 Ideal Thermo Property Package Manager
*
...
*
*This project (IdealThermo_CPP_PPM11) implements a CAPE-OPEN 
*version 1.1 Property Package Manager COM object. IdealThermoModule.dll
...
class CIdealThermo_CPP_PPM11Module : public CAtlDllModuleT< CIdealThermo_CPP_PPM11Module >
{
public :
	DECLARE_LIBID(LIBID_IdealThermo_CPP_PPM11Lib)
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_IDEALTHERMO_CPP_PPM11, "{9DEE31B5-5491-4EC2-94E1-6211EF138A72}")
};

CIdealThermo_CPP_PPM11Module _AtlModule;
