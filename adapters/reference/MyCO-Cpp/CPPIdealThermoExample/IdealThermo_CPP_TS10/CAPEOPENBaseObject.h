...
#define BASEMAP \
 ...
 COM_INTERFACE_ENTRY(ECapeIllegalAccess) \
 COM_INTERFACE_ENTRY(ECapeBadInvOrder) \
 COM_INTERFACE_ENTRY(ECapeInvalidArgument) \
 COM_INTERFACE_ENTRY(ECapeFailedInitialisation) \
 COM_INTERFACE_ENTRY(ECapeComputation) \
 COM_INTERFACE_ENTRY(ECapePersistenceSystemError) \
 COM_INTERFACE_ENTRY(ECapeNoImpl) \
...
class CAPEOPENBaseObject :
  ...
  public IDispatchImpl<ECapeIllegalAccess, &__uuidof(ECapeIllegalAccess), &LIBID_CAPEOPEN110, /* wMajor = */ 1, /* wMinor = */ 1>,
  public IDispatchImpl<ECapeInvalidArgument, &__uuidof(ECapeInvalidArgument), &LIBID_CAPEOPEN110, /* wMajor = */ 1, /* wMinor = */ 1>,
  public IDispatchImpl<ECapeBadInvOrder, &__uuidof(ECapeBadInvOrder), &LIBID_CAPEOPEN110, /* wMajor = */ 1, /* wMinor = */ 1>,
  public IDispatchImpl<ECapeFailedInitialisation, &__uuidof(ECapeFailedInitialisation), &LIBID_CAPEOPEN110, /* wMajor = */ 1, /* wMinor = */ 1>,
  public IDispatchImpl<ECapeComputation, &__uuidof(ECapeComputation), &LIBID_CAPEOPEN110, /* wMajor = */ 1, /* wMinor = */ 1>,
  public IDispatchImpl<ECapePersistenceSystemError, &__uuidof(ECapePersistenceSystemError), &LIBID_CAPEOPEN110, /* wMajor = */ 1, /* wMinor = */ 1>,
  public IDispatchImpl<ECapeNoImpl, &__uuidof(ECapeNoImpl), &LIBID_CAPEOPEN110, /* wMajor = */ 1, /* wMinor = */ 1>,
...
public:
    ...
    */
	...
	wstring operation;      /*!< expected operation in ECapeBadInvOrder */
    ...
    */
    ...
    //! ECapeBadInvOrder::get_requestedOperation
    /*!
      Gets the operation that should have been performed before returning ECapeBadInvOrderHR
      \param requestedOperation [out, retval] Expected operation
    */
	
    virtual HRESULT __stdcall get_requestedOperation (BSTR * requestedOperation)
    {*requestedOperation=SysAllocString(operation.c_str());
     return NOERROR;
    }
